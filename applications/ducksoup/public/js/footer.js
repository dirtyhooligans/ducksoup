$(document).ready(function(){
	...
	$("#aboutpanel").adjustPanel(); //Run the adjustPanel function on #about
	
	//Each time the viewport is adjusted/resized, execute the function
	$(window).resize(function () { 
		$("#chatpanel").adjustPanel();
		$("#aboutpanel").adjustPanel();
	});
	
	//Click event on Chat Panel + Alert Panel	
	$("#chatpanel a:first, #aboutpanel a:first").click(function() { //If clicked on the first link of #chatpanel and #about...
