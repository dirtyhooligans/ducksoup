...
require_once BASE_DIR . '/library/core/Config.php';
...
class Config_File extends Config
{
    ...
    protected function _parseIniFile($filename)
    {
       ...
       if ( $filename == "/Library/WebServer/Documents/videoegg/services/library/amfphp/services/../../../applications/faberge/configs/faberge.config")
       {
       	die('wtf:' . BASE_DIR);
       }
